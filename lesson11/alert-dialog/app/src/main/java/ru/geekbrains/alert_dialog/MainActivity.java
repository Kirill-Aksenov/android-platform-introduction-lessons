package ru.geekbrains.alert_dialog;
...
public class MainActivity extends AppCompatActivity {
                            ...
                            .setItems(items, new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialogInterface, int item) {
                                    Toast.makeText(MainActivity.this,
                                            String.format("Выбран пункт %d", item + 1), Toast.LENGTH_SHORT).show();
                                }
                            });
                    AlertDialog alert = builder.create();
                    alert.show();
    ...
    private View.OnClickListener clickAlertDialogListSingle = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            // В билдере указываем заголовок окна. Можно указывать как ресурс,так и строку
            builder.setTitle(R.string.exclamation)
                    // Добавляем список элементов; chosen — выбранный элемент,если = -1, то ни один не выбран
                    ...
                    .setPositiveButton("Ок", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            if (chosen == -1) {
                                Toast.makeText(MainActivity.this, "Ок, пункт не выбран!",
                                        Toast.LENGTH_SHORT).show();
                                return;
                            }
                            Toast.makeText(MainActivity.this, String.format("Ок, выбран '%s'!", items[chosen]),
                                    Toast.LENGTH_SHORT).show();
                        }
                    });
            AlertDialog alert = builder.create();
    ...
    private View.OnClickListener clickAlertDialogListMulti = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            // В билдере указываем заголовок окна (можно указывать как ресурс,так и строку)
            builder.setTitle(R.string.exclamation)
            // Добавляем список элементов; булев chosen — массив с выбранными элементами
                    .setMultiChoiceItems(items, chosen, new DialogInterface.OnMultiChoiceClickListener() {
                                @Override
                                public void onClick(DialogInterface dialogInterface, int i, boolean b) {
                                    chosen[i] = b; // При переключении обновляем ячейку в массиве
                                }
                            })
                    .setNegativeButton("Отмена", new DialogInterface.OnClickListener() {
                        @Override
